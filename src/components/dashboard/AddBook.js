    ...
    <div className="addContainer">
      ...
      <div className="addWrapper">
        ...
        <form onSubmit={handleSubmit(submitHandler)}>
         ...
         <div>
          <input type="number" name="amount" placeholder="Amount " {...register("amount", {required: true, max: 100, min: 1})}  />
          ...
          <select name="book_category" id="books"  defaultValue={''} {...register("book_category", {required: true})} >
