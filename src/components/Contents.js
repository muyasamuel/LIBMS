  ...
  return (
    <div className='contentsContainer'>
        <div className='contentsWrapper'>
            ...
            <h2> AddBook </h2>
            <h3> Here you are given the privilege to add new book that never existed before</h3>
        </div>
        <div onClick={navigateToEdit } className='searchContentDiv'>
            <FaSearch className='icon' />
            <h2>SearchFilter</h2>
            <h3> Search for whatever book that you think its available and given an option of editing or deleting respective books </h3>
        </div>
        <div onClick={navigateToIssueBook } className='issueContentDiv'>
            <FaBoxTissue className='icon'  />
            <h2>Issue Book</h2>
            <h3> Whenever a book is issued to a student all relevant details are noted done against the book issued</h3>
        </div>
